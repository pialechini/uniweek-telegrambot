...
bot.command("help", async (ctx) => {
  await ctx.reply(
    ...
    برای استفاده از این ربات باید دستور /set رو اجرا کنین. اونجا ربات ازتون توکن گلستان می خواد که باید با کامپیوتر یا لپتاپ وارد سایت گلستان بشین، بعدش گزارش ۸۸ یا ۷۸ (هر کدوم که در دسترسه) رو بیارین بالا و کلید F12 رو از روی صفحه کلید بزنین. (یک نکته بگم:‌ اگه از این لپتاپ جدیدا دارین ممکنه کلید F12 رو بزنین و هیچ صفحه ای براتون باز نشه. در این صورت کلید Fn رو نگه دارین و کلید F12 رو بزنین تا کار کنه). حالا توی پنجره باز شده داخل مرورگر روی قسمت console کلیک کنین و کدی که در پیام بعدی براتون ارسال کردم رو اونجا paste کنین و کلید Enter رو بزنین. یک متن انگلیسی عجیب و غریب روی صفحه تون میاد که حاوی برنامه هفتگیتون یا به اصطلاح توکن گلستانه. این رو کپی کنین و برای ربات بفرستین.
    `
  );
