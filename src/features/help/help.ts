...
const helpForSettingWeekSchedule = `توجه کنین که در این مرحله نیاز به لپتاپ یا کامپیوتر دارین و باقی قسمت های ربات بدون نیاز به لپتاپه (اگه رایانه و لپتاپ ندارین می تونین از یکی از دوستانتون برای انجام این مرحله کمک بگیرین).
